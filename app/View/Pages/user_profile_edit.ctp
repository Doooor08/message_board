        ...
        <div class="card-body d-flex justify-content-center">
            <form id="profile_form" enctype="multipart/form-data">
                <div class="d-flex justify-content-start align-items-center flex-row">
                    <input type="file" name="photo" id="imageInput" class="invisible d-none" accept="image/png, image/jpeg, image/gif" required>
                ...
                <div class="d-flex justify-content-end align-items-center flex-row my-3">
                    ...
                    <input type="text" name="name" id="name" class="form-control col-10 w-100" value="<?= $user['name'] ?>" placeholder="Enter your name" required>                
                </div>
                <div class="d-flex justify-content-end align-items-center flex-row my-3">
                    <label for="birthdate"class="mx-3 mb-0">Birthdate</label>
                    <input type="text" name="birthdate" id="birthdate" class="form-control col-10 w-100" value="<?= $user['birthdate'] ?>" placeholder="MM/DD/YYYY" required>
                </div>
